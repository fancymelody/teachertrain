...
export const store =new Vuex.Store({
    ...
    mutations:{
        setView(state,playload){
            ...
            state.classes[playload.id].content[playload.index].view="../../../static/images/teachertrain/video/right_icon.png",
            state.classes[playload.id].count++;
        }
    },
    getters:{
        getContent(state){
            ...
            state.classes[state.Id].progressvalue=(state.classes[state.Id].count/(state.classes[state.Id].content.length+1)*100).toFixed(1)
