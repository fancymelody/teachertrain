<template>
    <div class="videostudied">
        ...
        <div class="videomain">
            <div class="videoitem" v-for="(item,index) in studiedList">
            ...
            <pagination :num="studiedData.length" :limit="limit" @getNew="getNew" style="width: 100%"></pagination>
        </div>
    </div>
</template>
